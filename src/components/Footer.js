...
//   {
//     title: "Contact",
//     links: ["Nairobi, Kenya", "+254 716 944 544", "info@kimipay.com"],
//   },
//   {
//     title: "Quick Links",
//     links: ["About Us", "FAQs", "Privacy Policy", "Terms of Service"],
//   },
// ];
...
const Footer = () => {
    return ( 
        <footer className="relative w-full bg-black-400">
            <div className="mx-auto w-full max-w-7xl px-8">
                <div className="mx-auto grid w-full grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-3">
                    <div className="w-full">
                        ...
                        <ul className="space-y-1">
                            <Typography as="li" color="white" className="font-normal">
                                <p
                                className="inline-block py-1 pr-2"
                                >Nairobi, Kenya</p>
                            </Typography>
                            <Typography as="li" color="white" className="font-normal">
                                <p
                    ...
                    <div className="w-full">
                        ...
                        <p className="mt-4 text-lg leading-8 text-gray-300">Subscribe to get our monthly newsletter and stay up to date.</p>
                ...
                >
                    &copy; {currentYear} <a href="https://kimipay.com/">Kimipay</a>.
                </Typography>
